...
const Detail = () => {
    ...
    useEffect(() => {
      api.get(`points/${String(routeParams.point_id)}`).then(response => {
    ...
    function  handleWhatsapp() {
      Linking.openURL(`whatsapp://send?phone=55${data.point.whatsapp}&text=Interesse na coleta de residuos`)
    }
        ...
        <SafeAreaView style={{flex:1}}>
            <View style={styles.container}>
                    ...
                    <View style={styles.address}>
                        ...
                        <Text style={styles.addressContent}>Rido do Sul, SC</Text>
                    </View>
